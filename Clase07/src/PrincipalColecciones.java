...
public class PrincipalColecciones {
	...
	public static void main(String[] args) {
		...
		//Matriz dinámica de productos
		
		ArrayList misProductos = new ArrayList();
		
		//Añadir productos --> Método Add
		...
		System.out.println("Me cargo el primer objeto");
			...
			//Problema de las colecciones clásicas
			...
			//Da error de conversion en tiempo de ejecución porque hay un String
			...
			//Para resolver estos errores se crearon las colecciones genéricas
