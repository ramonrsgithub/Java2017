...
public class ArrancarJuego {
	...
	public static void main(String[] args) {
		...
		//Armar al soldado:Instanciación anónima
		soldado1.setFusil(new Fusil(49,"Colt56",40));
		
		soldado1.dispararFusil(2);
		System.out.println("Después de disparar 2 balas");
		...
		System.out.println("Después de cambiar el modelo de fusil");
		System.out.println(soldado1);
		System.out.println("Después de cambiar el modelo de fusil");
		System.out.println(soldado1);
		
		//Crear un ejército de 5 soldados
		
		Ejercito aleman = new Ejercito(5);
		//Alistar soldados en el ejército
